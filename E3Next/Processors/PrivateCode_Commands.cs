...
namespace E3Core.Processors
{
    public static class PrivateCommands
    {
        ...
        public static void RegisterCommandMezUp() {
            EventProcessor.RegisterCommand("/MezUp", (x) => {
                if (MQ.Query<string>("${Me.Class.ShortName}").Equals("ENC")) {
                    MQ.Write("Mezzing any mobs around me");
